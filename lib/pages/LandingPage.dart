...
String description = '''Hermoso lugar llamado ${movie.nombresitio}, ubicado en 
el  barrio ${movie.barrio} con dirección  ${movie.direccion}  en la comuna  ${movie.comuna}  es un atractivo
 tipo  ${movie.tipoatractivo}, no te  lo puedes perder.''';
    ...
    return Scaffold(
      // appBar: AppBar(title: Text(movie.tipoatractivo ?? "Detalle")),
